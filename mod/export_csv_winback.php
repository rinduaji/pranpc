...
a.msisdn_v1 AS MSISDN_V1,
a.msisdn_v2 AS MSISDN_V2,
a.area AS Area,
a.reg AS Regional,
a.branch AS Branch,
a.service_type AS Service_Type,
a.speed AS Speed,
a.bill_n0 AS Bill_N0,
a.bill_n1 AS Bill_N1,
a.arpu AS Arpu,
...
// print_r($csv_export);
// filename for export
$csv_filename = 'Data PRA_NPC WINBACK '.date('Y-m-d').' '.$site.'.csv';
