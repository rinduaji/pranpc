...
$query="SELECT a.id,a.tgl,a.login,b.user2,a.fastel,a.tlp,a.jenis,a.upd_qco,a.ket, a.add_on_tsel FROM app_tam_data2 AS a INNER JOIN cc147_main_users_extended AS b ON a.login = b.user1 $whr ";
//echo $query;
}else{
	$query="SELECT a.id,a.tgl,a.login,b.user2,a.fastel,a.tlp,a.jenis,a.upd_qco,a.ket,a.add_on_tsel FROM app_tam_data2 AS a INNER JOIN cc147_main_users_extended AS b ON a.login = b.user1 $whr ";
//echo $query;
						...
						<tr>
							...
							<tr>
								<div class="form-group">
									<label style="color:#FF0000">Login Agent</label>
									<input class="form-control input-sm" name="logagent" >
								</div>
							</tr>
							<tr>	
								<div class="form-group">
									<label style="color:#FF0000">No Fastel</label>
							...
							<div class="form-group">
								...
								<label class="control-label" style="color:#FF0000">Agent Site</label>
								...
								<div style="overflow-x:auto;">
									<table class="table table-hover table-striped">
										<thead>
											...
											<th align="center"><font color="red" face="Tahoma" size="2">Bayar</th>
