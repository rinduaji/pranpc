		...
		{   
			...
			echo "<div class=\"alert alert-danger\">Mohon periksa kembali! Input Anda ada yang belum di isi !</div>";
				...
				$sql = "INSERT INTO app_tam_winback (tgl,login,fastel,no_telp,nama_agent,nama_plg,msisdn_v1,msisdn_v2,area,reg,branch,service_type,speed,bill_n0,bill_n1,arpu,jenis,status,kategori,reason,follow,ket,upd_qco,input,valid) 
					VALUES ('$tgl','$login','$fastel','$no_telp_field','$nama_agent','$nama_plg','$msisdn_v1','$msisdn_v2','$area','$reg','$branch','$service_type','$speed','$bill_n0','$bill_n1','$arpu_field','$jenis','$status','$kategori','$reason','$follow','$ket','$login_qco','Recall','Not Valid')";
				//echo $sql;
				$query = mysqli_query($con,$sql);
				clearstatcache();
				$location="list_recall_winback.php";		
	...
	else if($status=="Contacted")
	{
		...
		echo "<div class=\"alert alert-danger\">Mohon periksa kembali! Input Anda ada yang belum di isi !</div>";
			...
			$sql = "INSERT INTO app_tam_winback (tgl,login,fastel,no_telp,nama_agent,nama_plg,msisdn_v1,msisdn_v2,area,reg,branch,service_type,speed,bill_n0,bill_n1,arpu,jenis,status,kategori,reason,follow,ket,upd_qco,input,valid,hasil_nego,janji_bayar) 
					VALUES ('$tgl','$login','$fastel','$no_telp_field','$nama_agent','$nama_plg','$msisdn_v1','$msisdn_v2','$area','$reg','$branch','$service_type','$speed','$bill_n0','$bill_n1','$arpu_field','$jenis','$status','$kategori','$reason','$follow','$ket','$login_qco','Recall','Not Valid','$hasil_nego','$janji_bayar')";
		...
		<div class="content">
			...
			<div class="col-md-12">
					<div class="card card-plain">
						<div class="header">
							<h4 class="title">INPUT CWC RECALL WINBACK <small><?php echo $nama; ?></small></h4>	
						</div>
				
				<form id='input' name="demoform" action='form_recall_winback.php?id=<?php echo "$id";?>' method='post' accept-charset='UTF-8'>
                <div>
                            <div class="row">
								<div class="col-md-4">
