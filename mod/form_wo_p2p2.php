										...
										<div style="overflow-x:auto;">
											<table class="table table-hover table-striped">
												<thead>
													...
													<th align="center">
														<font color="red" face="Tahoma" size="2">TANGGAL UPLOAD
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">FASTEL
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">EMAIL DB PROFILE
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">EMAIL KTTP
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">EMAIL MY IH
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">EMAIL REGIS
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">HP DB PROFILE
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">HP KTP
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">HP MY IH
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">HP REGIS
													</th>
													<th align="center">
												...
												<tbody>
													...
													while ($data = mysqli_fetch_array($hasil)) {
														echo "<tr>
																...
																<th align=\"center\" style=\"font-size:10px\">" . $data['email_ktp'] . "</th>
																<th align=\"center\" style=\"font-size:10px\">" . $data['email_myih'] . "</th>
																<th align=\"center\" style=\"font-size:10px\">" . $data['email_regis'] . "</th>
																<th align=\"center\" style=\"font-size:10px\">" . $data['hp_dbprofile'] . "</th>
																<th align=\"center\" style=\"font-size:10px\">" . $data['hp_ktp'] . "</th>
																<th align=\"center\" style=\"font-size:10px\">" . $data['hp_myih'] . "</th>
																<th align=\"center\" style=\"font-size:10px\">" . $data['hp_regis'] . "</th>
