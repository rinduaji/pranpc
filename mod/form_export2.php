					...
					<form id='input' name="demoform" action='export2_csv.php' method='post' accept-charset='UTF-8'>
						...
						<tr>	
							<div class="form-group">
								...
								<label class="control-label" style="color:#00BFFF">Data Transaksi</label>
						...
						<tr>	
							<div class="form-group">
								...
								<label class="control-label" style="color:#00BFFF">Product</label>
								<select  name="produk" class="form-control" value="<? echo $exp?>">	
									<option value="ALLprod" >ALL</option>
									<option value="TM 48">CT0</option>
									<option value="STB Tambahan">Pra NPC</option>
